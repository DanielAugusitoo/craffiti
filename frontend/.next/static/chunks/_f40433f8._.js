...
function CreatePage() {
    ...
    const [color, setColor] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("#06ffa5");
    const [brushSize, setBrushSize] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(5);
    ...
    const target = chainId ? __TURBOPACK__imported__module__$5b$project$5d2f$abi$2f$GraffitiChainAddresses$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["GraffitiChainAddresses"][String(chainId)] : undefined;
    const connect = async ()=>{
        if (!provider) return;
    ...
    const mintNFT = async ()=>{
        ...
        try {
            ...
            const mockUri = "ipfs://demo-".concat(Date.now());
            ...
            const tx = await c.mintGraffitiNFT(mockUri, title || "Untitled");
            await tx.wait();
...
_s(CreatePage, "KuvLT8OmmsjLTYHegPbirD186tE=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"]
    ];
});
...
//# sourceMappingURL=_f40433f8._.js.map